    ...
    <div class="mod-albums">
        <div  class="hd log url">
            ...
            <div class="container">
                <div class="gallery">
                    <div class="scroller">
                        <router-link :to="{name:'musicplay',params:{songId:item.song_id}}" tag="div" class="card url" v-for="(item,index) in newMusics" :key="index">
                            <div class="album">
   ...
   mounted(){
       ...
       .then(res=>{
        //    console.log(res.data)
            this.newMusics=res.data.song_list
       })
       .catch(err=>{
           console.log(err)
       })
